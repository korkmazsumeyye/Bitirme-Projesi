...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
msgbox('Puzzle oyununa hoşgeldiniz.Başla butonuna tıkla ve karşına çıkan pencereden resmini seç.Mause ile dağıtık resmin üstüne tıkla ve başla.BOL ŞANSLAR :) ','Oyun Kuralı','help','modal');
...
switch v
    ...
    case 31 % down arrow key
        ...
        clear ind
    otherwise
        msgbox('Geçersiz Karakter','DİKKAT...!!!','Error','modal')
        return
end
...
msgbox('Tebrikler Oyunu Tamamladınız . ','Oyun Bitti','help','modal')
...
hold on
text(50,75,'Ok Tuşlarını Kullan : ','FontSize',14,'Color','y','FontWeight','Bold');
